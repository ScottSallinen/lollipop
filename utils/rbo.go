...
func (s *RBOState) Update(e1, e2 int) {
	if s.shortDepth != -1 {
...
func (s *RBOState) CalcExtrapolated() float64 {
...
func CalculateRBO(s, t []int, p float64) float64 {
